...
namespace DendroGH
{
    ...
    public class VolumeGOO : GH_GeometricGoo<DendroVolume>, IGH_PreviewData, IGH_BakeAwareData
    {
        ...
        {
            obj_guid = Guid.Empty; // no object baked
            return true;           // or false, depending on whether you want to signal success
        }
        #endregion
        ...
        public override bool CastTo<Q>(out Q target)
        {
            ...
            // {
            //     target = (Q)(object)new GH_Mesh(Value.ToMesh(new DendroSettings()));
            //     return true;
            // }
