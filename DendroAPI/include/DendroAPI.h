...
extern "C"
{
	...
	extern DENDRO_API bool DendroFromCurves(DendroGrid *grid, const NativePointD *pts, size_t pCount, const NativeSegment *segs, size_t sCount, double radius, double voxelSize, double bandwidth);
